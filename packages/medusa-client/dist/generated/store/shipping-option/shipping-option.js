...
var getShippingOptions = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/shipping-options", method: 'get', params: params,
    });
};
...
var getShippingOptionsCartId = function (cartId) {
    return (0, custom_instance_1.getClient)({ url: "/shipping-options/".concat(cartId), method: 'get' });
};
