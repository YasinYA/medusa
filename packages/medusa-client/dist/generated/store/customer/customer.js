...
var postCustomersCustomerAddresses = function (postCustomersCustomerAddressesBody) {
    return (0, custom_instance_1.getClient)({ url: "/customers/me/addresses", method: 'post',
...
var postCustomers = function (postCustomersBody) {
    return (0, custom_instance_1.getClient)({ url: "/customers", method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteCustomersCustomerAddressesAddress = function (addressId) {
    return (0, custom_instance_1.getClient)({ url: "/customers/me/addresses/".concat(addressId), method: 'delete' });
};
...
var postCustomersCustomerAddressesAddress = function (addressId, postCustomersCustomerAddressesAddressBody) {
    return (0, custom_instance_1.getClient)({ url: "/customers/me/addresses/".concat(addressId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getCustomersCustomer = function () {
    return (0, custom_instance_1.getClient)({ url: "/customers/me", method: 'get' });
};
...
var postCustomersCustomer = function (postCustomersCustomerBody) {
    return (0, custom_instance_1.getClient)({ url: "/customers/me", method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getCustomersCustomerPaymentMethods = function () {
    return (0, custom_instance_1.getClient)({ url: "/customers/me/payment-methods", method: 'get' });
};
...
var getCustomersCustomerOrders = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/customers/me/orders", method: 'get', params: params,
    });
};
...
var postCustomersCustomerPasswordToken = function (postCustomersCustomerPasswordTokenBody) {
    return (0, custom_instance_1.getClient)({ url: "/customers/password-token", method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postCustomersResetPassword = function (postCustomersResetPasswordBody) {
    return (0, custom_instance_1.getClient)({ url: "/customers/reset-password", method: 'post',
        headers: { 'Content-Type': 'application/json' },
