...
var getCollectionsCollection = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/collections/".concat(id), method: 'get' });
};
...
var getCollections = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/collections", method: 'get', params: params,
    });
};
