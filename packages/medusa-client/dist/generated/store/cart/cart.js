...
var postCartsCartShippingMethod = function (id, postCartsCartShippingMethodBody) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/shipping-methods"), method: 'post',
...
var postCartsCartTaxes = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/taxes"), method: 'post' });
};
...
var postCartsCartComplete = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/complete"), method: 'post' });
};
...
var postCart = function (postCartBody) {
    return (0, custom_instance_1.getClient)({ url: "/carts", method: 'post',
        headers: { 'Content-Type': 'application/json' },
        data: postCartBody });
};
...
var postCartsCartLineItems = function (id, postCartsCartLineItemsBody) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/line-items"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postCartsCartPaymentSessions = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/payment-sessions"), method: 'post' });
};
...
var deleteCartsCartDiscountsDiscount = function (id, code) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/discounts/").concat(code), method: 'delete' });
};
...
var deleteCartsCartLineItemsItem = function (id, lineId) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/line-items/").concat(lineId), method: 'delete' });
};
...
var postCartsCartLineItemsItem = function (id, lineId, postCartsCartLineItemsItemBody) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/line-items/").concat(lineId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteCartsCartPaymentSessionsSession = function (id, providerId) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/payment-sessions/").concat(providerId), method: 'delete' });
};
...
var postCartsCartPaymentSessionUpdate = function (id, providerId, postCartsCartPaymentSessionUpdateBody) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/payment-sessions/").concat(providerId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postCartsCartPaymentSessionsSession = function (id, providerId) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/payment-sessions/").concat(providerId, "/refresh"), method: 'post' });
};
...
var postCartsCartPaymentSession = function (id, postCartsCartPaymentSessionBody) {
    return (0, custom_instance_1.getClient)({ url: "/carts/".concat(id, "/payment-session"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
*/
var postCartsCartPaymentMethodUpdate = function (id, postCartsCartPaymentMethodUpdateBody) {
    return (0, custom_instance_1.getClient)({ url: "/store/carts/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
        data: postCartsCartPaymentMethodUpdateBody });
};
exports.postCartsCartPaymentMethodUpdate = postCartsCartPaymentMethodUpdate;
