...
var postTaxRatesTaxRateProductTypes = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id/product-types/batch", method: 'post' });
};
...
var deleteTaxRatesTaxRateProductTypes = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id/product-types/batch", method: 'delete' });
};
...
var postTaxRatesTaxRateProducts = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id/products/batch", method: 'post' });
};
...
var deleteTaxRatesTaxRateProducts = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id/products/batch", method: 'delete' });
};
...
var postTaxRatesTaxRateShippingOptions = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id/shipping-options/batch", method: 'post' });
};
...
var deleteTaxRatesTaxRateShippingOptions = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id/shipping-options/batch", method: 'delete' });
};
...
var deleteTaxRatesTaxRate = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/".concat(id), method: 'delete' });
};
...
var getTaxRatesTaxRate = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id", method: 'get' });
};
...
var postTaxRatesTaxRate = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates/:id", method: 'post' });
};
