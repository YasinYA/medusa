...
var postProductsProductOptions = function (id, postProductsProductOptionsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/options"), method: 'post',
...
var postProducts = function (postProductsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products", method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getProducts = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products", method: 'get', params: params,
    });
};
...
var postProductsProductVariants = function (id, postProductsProductVariantsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/variants"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getProductsProductVariants = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/variants"), method: 'get' });
};
...
var deleteProductsProductOptionsOption = function (id, optionId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/options/").concat(optionId), method: 'delete' });
};
...
var postProductsProductOptionsOption = function (id, optionId, postProductsProductOptionsOptionBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/options/").concat(optionId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteProductsProduct = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id), method: 'delete' });
};
...
var getProductsProduct = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id), method: 'get' });
};
...
var postProductsProduct = function (id, postProductsProductBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteProductsProductVariantsVariant = function (id, variantId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/variants/").concat(variantId), method: 'delete' });
};
...
var postProductsProductVariantsVariant = function (id, variantId, postProductsProductVariantsVariantBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/variants/").concat(variantId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getProductsTypes = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/types", method: 'get' });
};
...
var postProductsProductMetadata = function (id, postProductsProductMetadataBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//products/".concat(id, "/metadata"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
