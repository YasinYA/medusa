...
var postNotes = function (postNotesBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//notes", method: 'post',
...
var deleteNotesNote = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//notes/".concat(id), method: 'delete' });
};
...
var getNotesNote = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//notes/".concat(id), method: 'get' });
};
...
var postNotesNote = function (id, postNotesNoteBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//notes/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
