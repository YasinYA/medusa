...
var postOrdersOrderShippingMethods = function (id, postOrdersOrderShippingMethodsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/shipping-methods"), method: 'post',
...
var postOrdersOrderArchive = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/archive"), method: 'post' });
};
...
var postOrdersOrderCancel = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/cancel"), method: 'post' });
};
...
var postOrdersOrderCapture = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/capture"), method: 'post' });
};
...
var postOrdersOrderComplete = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/complete"), method: 'post' });
};
...
var postOrdersOrderClaimsClaimShipments = function (id, claimId, postOrdersOrderClaimsClaimShipmentsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/claims/").concat(claimId, "/shipments"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderClaims = function (id, postOrdersOrderClaimsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//order/".concat(id, "/claims"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderFulfillments = function (id, postOrdersOrderFulfillmentsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/fulfillments"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrders = function (postOrdersBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders", method: 'post',
        headers: { 'Content-Type': 'application/json' },
        data: postOrdersBody });
};
...
var getOrders = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders", method: 'get', params: params,
    });
};
...
var postOrdersOrderShipment = function (id, postOrdersOrderShipmentBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/shipment"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderSwapsSwapShipments = function (id, swapId, postOrdersOrderSwapsSwapShipmentsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/swaps/").concat(swapId, "/shipments"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderSwaps = function (id, postOrdersOrderSwapsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//order/".concat(id, "/swaps"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteOrdersOrderMetadataKey = function (id, key) {
    return (0, custom_instance_1.getClient)({ url: "/admin//order/".concat(id, "/metadata/").concat(key), method: 'delete' });
};
...
var postOrdersOrderClaimsClaimFulfillments = function (id, claimId, postOrdersOrderClaimsClaimFulfillmentsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/claims/").concat(claimId, "/fulfillments"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderSwapsSwapFulfillments = function (id, swapId, postOrdersOrderSwapsSwapFulfillmentsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/swaps/").concat(swapId, "/fulfillments"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getOrdersOrder = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id), method: 'get' });
};
...
var postOrdersOrder = function (id, postOrdersOrderBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderSwapsSwapProcessPayment = function (id, swapId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/swaps/").concat(swapId, "/process-payment"), method: 'post' });
};
...
var postOrdersOrderRefunds = function (id, postOrdersOrderRefundsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/refunds"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderReturns = function (id, postOrdersOrderReturnsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/returns"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postOrdersOrderClaimsClaim = function (id, claimId, postOrdersOrderClaimsClaimBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//order/".concat(id, "/claims/").concat(claimId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getTaxRates = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//tax-rates", method: 'get', params: params,
    });
};
