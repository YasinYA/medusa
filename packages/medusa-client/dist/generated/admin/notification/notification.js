...
var getNotifications = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//notifications", method: 'get', params: params,
    });
};
...
var postNotificationsNotificationResend = function (id, postNotificationsNotificationResendBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//notifications/".concat(id, "/resend"), method: 'post',
