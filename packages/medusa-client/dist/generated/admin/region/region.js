...
var postRegionsRegionCountries = function (id, postRegionsRegionCountriesBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/countries"), method: 'post',
...
var postRegionsRegionFulfillmentProviders = function (id, postRegionsRegionFulfillmentProvidersBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/fulfillment-providers"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postRegionsRegionPaymentProviders = function (id, postRegionsRegionPaymentProvidersBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/payment-providers"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postRegions = function (postRegionsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions", method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getRegions = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions", method: 'get', params: params,
    });
};
...
var deleteRegionsRegionMetadataKey = function (id, key) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/metadata/").concat(key), method: 'delete' });
};
...
var deleteRegionsRegion = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id), method: 'delete' });
};
...
var getRegionsRegion = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id), method: 'get' });
};
...
var postRegionsRegion = function (id, postRegionsRegionBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getRegionsRegionFulfillmentOptions = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/fulfillment-options"), method: 'get' });
};
...
var postRegionsRegionCountriesCountry = function (id, countryCode) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/countries/").concat(countryCode), method: 'delete' });
};
...
var postRegionsRegionFulfillmentProvidersProvider = function (id, providerId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/fulfillment-providers/").concat(providerId), method: 'delete' });
};
...
var postRegionsRegionPaymentProvidersProvider = function (id, providerId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/payment-providers/").concat(providerId), method: 'delete' });
};
...
var postRegionsRegionMetadata = function (id, postRegionsRegionMetadataBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//regions/".concat(id, "/metadata"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
