...
var postShippingOptions = function (postShippingOptionsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-options", method: 'post',
...
var getShippingOptions = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-options", method: 'get', params: params,
    });
};
...
var deleteShippingOptionsOption = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-options/".concat(id), method: 'delete' });
};
...
var getShippingOptionsOption = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-options/".concat(id), method: 'get' });
};
...
var postShippingOptionsOption = function (id, postShippingOptionsOptionBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-options/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
