...
var postShippingProfiles = function (postShippingProfilesBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-profiles", method: 'post',
...
var getShippingProfiles = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-profiles", method: 'get' });
};
...
var deleteShippingProfilesProfile = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-profiles/".concat(id), method: 'delete' });
};
...
var getShippingProfilesProfile = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-profiles/".concat(id), method: 'get' });
};
...
var postShippingProfilesProfile = function (id, postShippingProfilesProfileBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//shipping-profiles/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
