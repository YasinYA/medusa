...
var postDraftOrders = function (postDraftOrdersBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders", method: 'post',
...
var getDraftOrders = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders", method: 'get' });
};
...
var postDraftOrdersDraftOrderLineItems = function (id, postDraftOrdersDraftOrderLineItemsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders/".concat(id, "/line-items"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteDraftOrdersDraftOrder = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders/".concat(id), method: 'delete' });
};
...
var getDraftOrdersDraftOrder = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders/".concat(id), method: 'get' });
};
...
var deleteDraftOrdersDraftOrderLineItemsItem = function (id, lineId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders/".concat(id, "/line-items/").concat(lineId), method: 'delete' });
};
...
var postDraftOrdersDraftOrderLineItemsItem = function (id, lineId, postDraftOrdersDraftOrderLineItemsItemBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders/".concat(id, "/line-items/").concat(lineId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var postDraftOrdersDraftOrderRegisterPayment = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//draft-orders/".concat(id, "/register-payment"), method: 'post' });
};
...
var postDraftOrdersDraftOrder = function (id, postDraftOrdersDraftOrderBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//admin/draft-orders/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
