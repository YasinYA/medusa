...
var getProductTags = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//product-tags", method: 'get', params: params,
    });
};
...
var getProductTypes = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//product-types", method: 'get', params: params,
    });
};
