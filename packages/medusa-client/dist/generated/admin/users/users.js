...
var postUsers = function (postUsersBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//users", method: 'post',
...
var deleteUsersUser = function (userId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//users/".concat(userId), method: 'delete' });
};
...
var postUsersUser = function (userId, postUsersUserBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//users/".concat(userId), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getUsersUser = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//users/".concat(id), method: 'get' });
};
...
var postUsersUserPassword = function (postUsersUserPasswordBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//users/password-token", method: 'post',
        headers: { 'Content-Type': 'application/json' },
