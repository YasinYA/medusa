...
var postCustomers = function (postCustomersBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//customers", method: 'post',
...
var getCustomersCustomer = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//customers/".concat(id), method: 'get' });
};
...
var postCustomersCustomer = function (id, postCustomersCustomerBody, params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//customers/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
