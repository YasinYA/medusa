...
var postStoreCurrenciesCode = function (code) {
    return (0, custom_instance_1.getClient)({ url: "/admin//store/currencies/".concat(code), method: 'post' });
};
...
var deleteStoreCurrenciesCode = function (code) {
    return (0, custom_instance_1.getClient)({ url: "/admin//store/currencies/".concat(code), method: 'delete' });
};
...
var postStore = function (postStoreBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//store", method: 'post',
...
var getStorePaymentProviders = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//store/payment-providers", method: 'get' });
};
...
var getStoreTaxProviders = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//store/tax-providers", method: 'get' });
};
