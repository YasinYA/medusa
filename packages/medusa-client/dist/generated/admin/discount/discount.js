...
exports.getDiscountsDiscountCode = exports.deleteDiscountsDiscountDynamicCodesCode = exports.postDiscountsDiscount = exports.getDiscountsDiscount = exports.deleteDiscountsDiscount = exports.postDiscountsDiscountDynamicCodes = exports.getDiscounts = exports.postDiscounts = exports.deleteDiscountsDiscountProductsProduct = exports.postDiscountsDiscountProductsProduct = exports.deleteDiscountsDiscountRegionsRegion = exports.postDiscountsDiscountRegionsRegion = void 0;
...
var postDiscountsDiscountRegionsRegion = function (id, regionId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id, "/regions/").concat(regionId), method: 'post' });
};
...
var deleteDiscountsDiscountRegionsRegion = function (id, regionId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id, "/regions/").concat(regionId), method: 'delete' });
};
...
*/
var postDiscountsDiscountProductsProduct = function (id, productId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id, "/products/").concat(productId), method: 'post' });
};
exports.postDiscountsDiscountProductsProduct = postDiscountsDiscountProductsProduct;
/**
* Removes a Product from the list of Products that a Discount can be used for.
* @summary Remove Product availability
*/
var deleteDiscountsDiscountProductsProduct = function (id, productId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id, "/products/").concat(productId), method: 'delete' });
};
exports.deleteDiscountsDiscountProductsProduct = deleteDiscountsDiscountProductsProduct;
/**
...
var postDiscounts = function (postDiscountsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts", method: 'post',
...
var getDiscounts = function (params) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts", method: 'get', params: params,
    });
};
...
var postDiscountsDiscountDynamicCodes = function (id, postDiscountsDiscountDynamicCodesBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id, "/dynamic-codes"), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteDiscountsDiscount = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id), method: 'delete' });
};
...
*/
var getDiscountsDiscount = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id), method: 'get' });
};
...
var postDiscountsDiscount = function (id, postDiscountsDiscountBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteDiscountsDiscountDynamicCodesCode = function (id, code) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/".concat(id, "/dynamic-codes/").concat(code), method: 'delete' });
};
...
var getDiscountsDiscountCode = function (code) {
    return (0, custom_instance_1.getClient)({ url: "/admin//discounts/code/".concat(code), method: 'get' });
};
