...
var postGiftCards = function (postGiftCardsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//gift-cards", method: 'post',
...
var deleteGiftCardsGiftCard = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//gift-cards/".concat(id), method: 'delete' });
};
...
var getGiftCardsGiftCard = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//gift-cards/".concat(id), method: 'get' });
};
...
var postGiftCardsGiftCard = function (id, postGiftCardsGiftCardBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//gift-cards/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
