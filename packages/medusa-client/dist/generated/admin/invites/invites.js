...
var postInvitesInviteAccept = function (postInvitesInviteAcceptBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//invites/accept", method: 'post',
...
var postInvites = function (postInvitesBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//invites", method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var deleteInvitesInvite = function (inviteId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//invites/".concat(inviteId), method: 'delete' });
};
...
var postInvitesInviteResend = function (inviteId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//invites/".concat(inviteId, "/resend"), method: 'post' });
};
