...
var postReturnReasons = function (postReturnReasonsBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//return-reasons", method: 'post',
...
var getReturnReasons = function () {
    return (0, custom_instance_1.getClient)({ url: "/admin//return-reasons", method: 'get' });
};
...
var deleteReturnReason = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//return-reasons/".concat(id), method: 'delete' });
};
...
var getReturnReasonsReason = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//return-reasons/".concat(id), method: 'get' });
};
...
var postReturnReasonsReason = function (id, postReturnReasonsReasonBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//return-reasons/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
