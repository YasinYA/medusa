...
var postReturnsReturnCancel = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//returns/".concat(id, "/cancel"), method: 'post' });
};
...
var postReturnsReturnReceive = function (id, postReturnsReturnReceiveBody) {
    return (0, custom_instance_1.getClient)({ url: "/admin//returns/".concat(id, "/receive"), method: 'post',
