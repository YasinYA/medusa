...
var postOrdersClaimFulfillmentsCancel = function (id, claimId, fulfillmentId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/claims/").concat(claimId, "/fulfillments/").concat(fulfillmentId, "/cancel"), method: 'post' });
};
...
var postOrdersSwapFulfillmentsCancel = function (id, swapId, fulfillmentId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/swaps/").concat(swapId, "/fulfillments/").concat(fulfillmentId, "/cancel"), method: 'post' });
};
...
var postOrdersOrderFulfillmentsCancel = function (id, fulfillmentId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/fulfillments/").concat(fulfillmentId, "/cancel"), method: 'post' });
};
