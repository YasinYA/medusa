...
var postOrdersSwapCancel = function (id, swapId) {
    return (0, custom_instance_1.getClient)({ url: "/admin//orders/".concat(id, "/swaps/").concat(swapId, "/cancel"), method: 'post' });
};
...
var getSwapsSwap = function (id) {
    return (0, custom_instance_1.getClient)({ url: "/admin//swaps/".concat(id), method: 'get' });
};
