...
export const getPostCustomersCustomerAddressesMock = () => ({customer: faker.helpers.randomize([{}, undefined])})

export const getPostCustomersMock = () => ({customer: faker.helpers.randomize([{}, undefined])})

export const getDeleteCustomersCustomerAddressesAddressMock = () => ({customer: faker.helpers.randomize([{}, undefined])})

export const getPostCustomersCustomerAddressesAddressMock = () => ({customer: faker.helpers.randomize([{}, undefined])})
...
export const getGetCustomersCustomerPaymentMethodsMock = () => ({payment_methods: faker.helpers.randomize([[...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({provider_id: faker.helpers.randomize([faker.random.word(), undefined]), data: faker.helpers.randomize([{}, undefined])})), undefined])})

export const getGetCustomersCustomerOrdersMock = () => ({count: faker.helpers.randomize([faker.datatype.number(), undefined]), offset: faker.helpers.randomize([faker.datatype.number(), undefined]), limit: faker.helpers.randomize([faker.datatype.number(), undefined]), orders: faker.helpers.randomize([[...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({})), undefined])})

export const getPostCustomersResetPasswordMock = () => ({customer: faker.helpers.randomize([{}, undefined])})
