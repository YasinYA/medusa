...
ctx.json(getPostOrdersOrderCompleteMock()),
      ...
      }),rest.post('*/admin/orders/:id/claims/:claimid/shipments', (_req, res, ctx) => {
        return res(
          ctx.delay(1000),
          ctx.status(200, 'Mocked status'),
...
ctx.json(getDeleteOrdersOrderMetadataKeyMock()),
      ...
      }),rest.post('*/admin/orders/:id/claims/:claimid/fulfillments', (_req, res, ctx) => {
        return res(
          ctx.delay(1000),
          ctx.status(200, 'Mocked status'),
ctx.json(getPostOrdersOrderClaimsClaimFulfillmentsMock()),
        )
      }),rest.post('*/admin/orders/:id/swaps/:swapid/fulfillments', (_req, res, ctx) => {
        return res(
          ctx.delay(1000),
          ctx.status(200, 'Mocked status'),
...
ctx.json(getPostOrdersOrderMock()),
      ...
      }),rest.post('*/admin/orders/:id/swaps/:swapid/process-payment', (_req, res, ctx) => {
        return res(
          ctx.delay(1000),
          ctx.status(200, 'Mocked status'),
