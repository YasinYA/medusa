...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    auth: {
         ...
         * @request DELETE:/auth
         */
        deleteAuth: (params?: RequestParams) => Promise<AxiosResponse<void, any>>;
        /**
         ...
         */
        getAuthEmail: (email: string, params?: RequestParams) => Promise<AxiosResponse<{
    ...
    customers: {
         ...
         */
        postCustomersCustomerAddresses: (data: {
            address: Address;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            customer?: Customer | undefined;
        }, any>>;
         ...
         */
        deleteCustomersCustomerAddressesAddress: (addressId: string, params?: RequestParams) => Promise<AxiosResponse<{
            customer?: Customer | undefined;
        }, any>>;
        /**
         ...
         */
        postCustomersCustomerAddressesAddress: (addressId: string, data: {
            address?: Address;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            customer?: Customer | undefined;
        }, any>>;
         ...
         */
        getCustomersCustomer: (params?: RequestParams) => Promise<AxiosResponse<{
            customer?: Customer | undefined;
        }, any>>;
        /**
         ...
         */
        getCustomersCustomerPaymentMethods: (params?: RequestParams) => Promise<AxiosResponse<{
            payment_methods?: {
         ...
         */
        getCustomersCustomerOrders: (query?: {
            limit?: number | undefined;
            offset?: number | undefined;
         ...
         */
        postCustomersCustomerPasswordToken: (data: {
            email: string;
         ...
         */
        postCustomersResetPassword: (data: {
            email: string;
            token: string;
            password: string;
        }, params?: RequestParams) => Promise<AxiosResponse<{
    ...
    giftCards: {
         ...
         */
        getGiftCardsCode: (code: string, params?: RequestParams) => Promise<AxiosResponse<{
            id?: any;
            code?: any;
            value?: any;
            balance?: any;
    ...
    carts: {
         ...
         */
        postCartsCartShippingMethod: (id: string, data: {
            option_id: string;
            data?: object | undefined;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
         ...
         */
        postCartsCartTaxes: (id: string, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
        /**
         ...
         */
        postCartsCartComplete: (id: string, params?: RequestParams) => Promise<AxiosResponse<{
         ...
         */
        postCartsCartLineItems: (id: string, data: {
            variant_id: string;
            quantity: number;
            metadata?: object;
        }, params?: RequestParams) => Promise<AxiosResponse<{
         ...
         */
        postCartsCartPaymentSessions: (id: string, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
        /**
         ...
         */
        deleteCartsCartDiscountsDiscount: (id: string, code: string, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
        /**
         ...
         */
        deleteCartsCartLineItemsItem: (id: string, lineId: string, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
        /**
         ...
         */
        postCartsCartLineItemsItem: (id: string, lineId: string, data: {
            quantity: number;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
         ...
         */
        deleteCartsCartPaymentSessionsSession: (id: string, providerId: string, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
        /**
         ...
         */
        postCartsCartPaymentSessionUpdate: (id: string, providerId: string, data: {
            data: object;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
         ...
         */
        getCartsCart: (id: string, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
        /**
         ...
         */
        postCartsCartPaymentSessionsSession: (id: string, providerId: string, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
        /**
         ...
         */
        postCartsCartPaymentSession: (id: string, data: {
            provider_id: string;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
        }, any>>;
    ...
    store: {
         ...
         */
        postCartsCartPaymentMethodUpdate: (id: string, data: {
            provider_id: string;
            data?: object | undefined;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            cart?: Cart | undefined;
    ...
    orders: {
         ...
         */
        getOrdersOrderCartId: (cartId: string, params?: RequestParams) => Promise<AxiosResponse<{
            order?: Order | undefined;
        }, any>>;
        /**
    ...
    regions: {
         ...
         * @request GET:/regions
         */
        getRegions: (params?: RequestParams) => Promise<AxiosResponse<{
            count?: number | undefined;
            offset?: number | undefined;
            limit?: number | undefined;
    ...
    shippingOptions: {
         ...
         */
        getShippingOptionsCartId: (cartId: string, params?: RequestParams) => Promise<AxiosResponse<{
            shipping_options?: ShippingOption[] | undefined;
        }, any>>;
    };
    swaps: {
         ...
         */
        getSwapsSwapCartId: (cartId: string, params?: RequestParams) => Promise<AxiosResponse<{
            swap?: Swap | undefined;
        }, any>>;
    };
    variants: {
         ...
         */
        getVariantsVariant: (variantId: string, params?: RequestParams) => Promise<AxiosResponse<{
