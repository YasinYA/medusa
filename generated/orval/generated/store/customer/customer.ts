...
export const postCustomersCustomerAddresses = (
    postCustomersCustomerAddressesBody: PostCustomersCustomerAddressesBody,
      ...
      return customInstance<PostCustomersCustomerAddresses200>(
      {url: `/customers/me/addresses`, method: 'post',
 ...
 */
export const deleteCustomersCustomerAddressesAddress = (
    addressId: string,
 ) => {
      return customInstance<DeleteCustomersCustomerAddressesAddress200>(
      {url: `/customers/me/addresses/${addressId}`, method: 'delete'
    },
      );
    }
  /**
...
export const postCustomersCustomerAddressesAddress = (
    ...
    postCustomersCustomerAddressesAddressBody: PostCustomersCustomerAddressesAddressBody,
      ...
      return customInstance<PostCustomersCustomerAddressesAddress200>(
      {url: `/customers/me/addresses/${addressId}`, method: 'post',
      headers: {'Content-Type': 'application/json'},
...
export const getCustomersCustomerPaymentMethods = (
      ...
      return customInstance<GetCustomersCustomerPaymentMethods200>(
      {url: `/customers/me/payment-methods`, method: 'get'
    },
      );
    }
  /**
...
export const getCustomersCustomerOrders = (
    params?: GetCustomersCustomerOrdersParams,
      ...
      return customInstance<GetCustomersCustomerOrders200>(
      {url: `/customers/me/orders`, method: 'get',
        params,
    },
      );
    }
...
export const postCustomersCustomerPasswordToken = (
    postCustomersCustomerPasswordTokenBody: PostCustomersCustomerPasswordTokenBody,
      ...
      {url: `/customers/password-token`, method: 'post',
      headers: {'Content-Type': 'application/json'},
...
export const postCustomersResetPassword = (
    postCustomersResetPasswordBody: PostCustomersResetPasswordBody,
      ...
      return customInstance<PostCustomersResetPassword200>(
      {url: `/customers/reset-password`, method: 'post',
      headers: {'Content-Type': 'application/json'},
...
export type PostCustomersCustomerAddressesResult = NonNullable<AsyncReturnType<typeof postCustomersCustomerAddresses>>
export type PostCustomersResult = NonNullable<AsyncReturnType<typeof postCustomers>>
export type DeleteCustomersCustomerAddressesAddressResult = NonNullable<AsyncReturnType<typeof deleteCustomersCustomerAddressesAddress>>
export type PostCustomersCustomerAddressesAddressResult = NonNullable<AsyncReturnType<typeof postCustomersCustomerAddressesAddress>>
...
export type GetCustomersCustomerPaymentMethodsResult = NonNullable<AsyncReturnType<typeof getCustomersCustomerPaymentMethods>>
export type GetCustomersCustomerOrdersResult = NonNullable<AsyncReturnType<typeof getCustomersCustomerOrders>>
export type PostCustomersCustomerPasswordTokenResult = NonNullable<AsyncReturnType<typeof postCustomersCustomerPasswordToken>>
export type PostCustomersResetPasswordResult = NonNullable<AsyncReturnType<typeof postCustomersResetPassword>>