 ...
 */
export const postSwaps = (
    postSwapsBody: PostSwapsBody,
 ) => {
      return customInstance<PostSwaps200>(
      {url: `/swaps`, method: 'post',
 ...
 */
export const getSwapsSwapCartId = (
    cartId: string,
 ) => {
      return customInstance<GetSwapsSwapCartId200>(
      {url: `/swaps/${cartId}`, method: 'get'
    },
      );
    }
...
export type GetSwapsSwapCartIdResult = NonNullable<AsyncReturnType<typeof getSwapsSwapCartId>>