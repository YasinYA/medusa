...
export const postCartsCartShippingMethod = (
    ...
    postCartsCartShippingMethodBody: PostCartsCartShippingMethodBody,
      ...
      return customInstance<PostCartsCartShippingMethod200>(
      {url: `/carts/${id}/shipping-methods`, method: 'post',
 ...
 */
export const postCartsCartTaxes = (
    id: string,
 ) => {
      return customInstance<PostCartsCartTaxes200OneOf>(
      {url: `/carts/${id}/taxes`, method: 'post'
    },
      );
    }
  /**
 ...
 */
export const postCartsCartComplete = (
    id: string,
 ) => {
      return customInstance<PostCartsCartComplete200>(
      {url: `/carts/${id}/complete`, method: 'post'
    },
      );
    }
  /**
...
export const postCart = (
    postCartBody: PostCartBody,
      ...
      return customInstance<PostCart200>(
...
export const postCartsCartLineItems = (
    ...
    postCartsCartLineItemsBody: PostCartsCartLineItemsBody,
      ...
      return customInstance<PostCartsCartLineItems200>(
      {url: `/carts/${id}/line-items`, method: 'post',
      headers: {'Content-Type': 'application/json'},
 ...
 */
export const postCartsCartPaymentSessions = (
    id: string,
 ) => {
      return customInstance<PostCartsCartPaymentSessions200>(
      {url: `/carts/${id}/payment-sessions`, method: 'post'
    },
      );
    }
  /**
 ...
 */
export const deleteCartsCartDiscountsDiscount = (
    id: string,
    code: string,
 ) => {
      return customInstance<DeleteCartsCartDiscountsDiscount200>(
      {url: `/carts/${id}/discounts/${code}`, method: 'delete'
    },
      );
    }
  /**
 ...
 */
export const deleteCartsCartLineItemsItem = (
    id: string,
    lineId: string,
 ) => {
      return customInstance<DeleteCartsCartLineItemsItem200>(
      {url: `/carts/${id}/line-items/${lineId}`, method: 'delete'
    },
      );
    }
  /**
...
export const postCartsCartLineItemsItem = (
    ...
    postCartsCartLineItemsItemBody: PostCartsCartLineItemsItemBody,
      ...
      return customInstance<PostCartsCartLineItemsItem200>(
      {url: `/carts/${id}/line-items/${lineId}`, method: 'post',
      headers: {'Content-Type': 'application/json'},
...
export const deleteCartsCartPaymentSessionsSession = (
    ...
    providerId: string,
      ...
      return customInstance<DeleteCartsCartPaymentSessionsSession200>(
      {url: `/carts/${id}/payment-sessions/${providerId}`, method: 'delete'
    },
      );
    }
  /**
...
export const postCartsCartPaymentSessionUpdate = (
    ...
    postCartsCartPaymentSessionUpdateBody: PostCartsCartPaymentSessionUpdateBody,
      ...
      return customInstance<PostCartsCartPaymentSessionUpdate200>(
      {url: `/carts/${id}/payment-sessions/${providerId}`, method: 'post',
      headers: {'Content-Type': 'application/json'},
 ...
 */
export const getCartsCart = (
    id: string,
 ) => {
      return customInstance<GetCartsCart200>(
      {url: `/carts/${id}`, method: 'get'
    },
      );
    }
  /**
...
export const postCartsCartPaymentSessionsSession = (
    ...
    providerId: string,
      ...
      return customInstance<PostCartsCartPaymentSessionsSession200>(
      {url: `/carts/${id}/payment-sessions/${providerId}/refresh`, method: 'post'
    },
      );
    }
  /**
...
export const postCartsCartPaymentSession = (
    ...
    postCartsCartPaymentSessionBody: PostCartsCartPaymentSessionBody,
      ...
      return customInstance<PostCartsCartPaymentSession200>(
      {url: `/carts/${id}/payment-session`, method: 'post',
      headers: {'Content-Type': 'application/json'},
...
export const postCartsCartPaymentMethodUpdate = (
    ...
    postCartsCartPaymentMethodUpdateBody: PostCartsCartPaymentMethodUpdateBody,
      ...
      return customInstance<PostCartsCartPaymentMethodUpdate200>(
...
export type PostCartsCartShippingMethodResult = NonNullable<AsyncReturnType<typeof postCartsCartShippingMethod>>
export type PostCartsCartTaxesResult = NonNullable<AsyncReturnType<typeof postCartsCartTaxes>>
export type PostCartsCartCompleteResult = NonNullable<AsyncReturnType<typeof postCartsCartComplete>>
export type PostCartResult = NonNullable<AsyncReturnType<typeof postCart>>
export type PostCartsCartLineItemsResult = NonNullable<AsyncReturnType<typeof postCartsCartLineItems>>
export type PostCartsCartPaymentSessionsResult = NonNullable<AsyncReturnType<typeof postCartsCartPaymentSessions>>
export type DeleteCartsCartDiscountsDiscountResult = NonNullable<AsyncReturnType<typeof deleteCartsCartDiscountsDiscount>>
export type DeleteCartsCartLineItemsItemResult = NonNullable<AsyncReturnType<typeof deleteCartsCartLineItemsItem>>
export type PostCartsCartLineItemsItemResult = NonNullable<AsyncReturnType<typeof postCartsCartLineItemsItem>>
export type DeleteCartsCartPaymentSessionsSessionResult = NonNullable<AsyncReturnType<typeof deleteCartsCartPaymentSessionsSession>>
export type PostCartsCartPaymentSessionUpdateResult = NonNullable<AsyncReturnType<typeof postCartsCartPaymentSessionUpdate>>
export type GetCartsCartResult = NonNullable<AsyncReturnType<typeof getCartsCart>>
export type PostCartsCartPaymentSessionsSessionResult = NonNullable<AsyncReturnType<typeof postCartsCartPaymentSessionsSession>>
export type PostCartsCartPaymentSessionResult = NonNullable<AsyncReturnType<typeof postCartsCartPaymentSession>>
export type PostCartsCartPaymentMethodUpdateResult = NonNullable<AsyncReturnType<typeof postCartsCartPaymentMethodUpdate>>