...
var postProductsToCollection = function (id, postProductsToCollectionBody) {
    return (0, custom_instance_1.customInstance)({ url: "/collections/".concat(id, "/products/batch"), method: 'post',
...
var deleteProductsFromCollection = function (id, deleteProductsFromCollectionBody) {
    return (0, custom_instance_1.customInstance)({ url: "/collections/".concat(id, "/products/batch"), method: 'delete',
        headers: { 'Content-Type': 'application/json' },
...
var postCollections = function (postCollectionsBody) {
    return (0, custom_instance_1.customInstance)({ url: "/collections", method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getCollections = function (params) {
    return (0, custom_instance_1.customInstance)({ url: "/collections", method: 'get', params: params,
    });
};
...
var deleteCollectionsCollection = function (id) {
    return (0, custom_instance_1.customInstance)({ url: "/collections/".concat(id), method: 'delete' });
};
...
var getCollectionsCollection = function (id) {
    return (0, custom_instance_1.customInstance)({ url: "/collections/".concat(id), method: 'get' });
};
...
var postCollectionsCollection = function (id, postCollectionsCollectionBody) {
    return (0, custom_instance_1.customInstance)({ url: "/collections/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
