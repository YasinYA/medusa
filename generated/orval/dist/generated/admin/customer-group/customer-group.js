...
var postCustomerGroups = function (postCustomerGroupsBody) {
    return (0, custom_instance_1.customInstance)({ url: "/customer-groups", method: 'post',
...
var deleteCustomerGroupsCustomerGroup = function (id) {
    return (0, custom_instance_1.customInstance)({ url: "/customer-groups/".concat(id), method: 'delete' });
};
...
var postCustomerGroupsGroup = function (id, postCustomerGroupsGroupBody) {
    return (0, custom_instance_1.customInstance)({ url: "/customer-groups/".concat(id), method: 'post',
        headers: { 'Content-Type': 'application/json' },
...
var getCustomerGroupsGroup = function (id) {
    return (0, custom_instance_1.customInstance)({ url: "/customer-group/".concat(id), method: 'get' });
};
